// ios-install.js - Popup d'installation iOS pour Gestionnaire de Dépenses
(function() {
    'use strict';
    ...
    function showIOSInstallPrompt() {
        ...
        const lastPrompt = localStorage.getItem('depensesIOSPromptShown');
        const now = Date.now();
        ...
        iosPrompt.innerHTML = `
            ...
            <div class="ios-prompt-card">
                <div class="ios-prompt-header">
                    ...
                    <h3>Installer Mes Dépenses</h3>
                    <button class="ios-prompt-close">&times;</button>
                </div>
                
                <div class="ios-prompt-content">
                    <p class="ios-prompt-subtitle">Ajoutez l'app à votre ${deviceName} pour gérer vos dépenses facilement !</p>
        ...
        const closePrompt = () => {
            ...
            localStorage.setItem('depensesIOSPromptShown', now.toString());
        };
    ...
    style.textContent = `
        ...
        [data-theme="dark"] .ios-btn-later:hover {
            background: #475569;
        }
    ...
    // Initialisation
    console.log("📱 Script iOS Install chargé pour Gestionnaire de Dépenses");
    ...
    window.testIOSPopupDepenses = () => {
        console.log("🧪 Test manuel du popup iOS");
        localStorage.removeItem('depensesIOSPromptShown');
        showIOSInstallPrompt();
    };
